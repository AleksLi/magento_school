...
class Itdelight_First_Model_Resource_Eav_Mysql4_Setup extends Mage_Eav_Model_Entity_Setup
{
...
*/
    ...
    protected function _prepareValues($attr)
    {
        ...
        $data = array_merge($data, array(
            ...
            'is_global'                     => $this->_getValue($attr, 'global', Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_WEBSITE ),
